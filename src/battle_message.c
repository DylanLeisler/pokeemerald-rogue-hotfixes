...
static const u8 sText_BoosterEnergy[] = _("{B_PLAYER_MON1_NAME} consumed its Booster Energy!\n{B_BUFF1} was heightened.");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_BOOSTERENERGY - BATTLESTRINGS_TABLE_START] = sText_BoosterEnergy,
};
