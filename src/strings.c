...
const u8 gText_PokedexEvoGenderSwap[] = _("Get {COLOR GREEN}{SHADOW LIGHT_GREEN}Gender Swapped.");
...
const u8 gPCText_City[] = _("Squirty");
...
const u8 gPCText_PolkaDot[] = _("Poké-dot");
