...
static u16 const sDynamicCustomMonAbilities[] = 
{
    ...
    ABILITY_NO_GUARD,
    ABILITY_SKILL_LINK,
    ABILITY_FUR_COAT, //ABILITY_SHELL_ARMOR,
    ABILITY_GUTS,
    ABILITY_THICK_FAT,
    ABILITY_ROCK_HEAD, //ABILITY_HUGE_POWER, //30
    ABILITY_SERENE_GRACE,
    ABILITY_DISGUISE, //ABILITY_BATTLE_ARMOR,
    ABILITY_WEAK_ARMOR,
    ...
    ABILITY_IRON_BARBS,
    ABILITY_DEFIANT, //60
    ABILITY_PIXILATE, //ABILITY_STALL,
    ABILITY_SNIPER,
    ABILITY_MULTITYPE, //breakpoint for original size of <= 63
    ABILITY_STURDY,
    ABILITY_CLOUD_NINE,
    ABILITY_MAGICIAN,
    ABILITY_SCRAPPY,
    ABILITY_BEAST_BOOST,
    ABILITY_OWN_TEMPO,
    ABILITY_SHADOW_TAG, //70
    ABILITY_PERISH_BODY,
    ABILITY_QUEENLY_MAJESTY,
    ABILITY_PROTOSYNTHESIS,
    ABILITY_QUARK_DRIVE,
    ABILITY_COLOR_CHANGE,
    ABILITY_POISON_PUPPETEER, //76
    ABILITY_TRACE,
    ABILITY_SURGE_SURFER,
    ABILITY_POWER_SPOT,
    ABILITY_FRIEND_GUARD, //80
...
static u16 const sDynamicCustomMonMoves[] = 
{
#ifdef ROGUE_EXPANSION
    MOVE_HYDRO_STEAM,
    MOVE_ICE_BEAM,//MOVE_CHILLING_WATER,
    MOVE_TORCH_SONG,
    MOVE_JET_PUNCH,
    MOVE_STONE_AXE,
    ...
    MOVE_PARTING_SHOT,
    MOVE_EARTHQUAKE,//MOVE_GRASSY_GLIDE,
    MOVE_DYNAMAX_CANNON,
    MOVE_TRANSFORM,//MOVE_STOMPING_TANTRUM,
    MOVE_BANEFUL_BUNKER,
    MOVE_DIAMOND_STORM,
    MOVE_PLAY_ROUGH,
    MOVE_FREEZE_DRY,
    ...
    MOVE_PAY_DAY,//MOVE_ROLLOUT,
    MOVE_OUTRAGE,//MOVE_FURY_CUTTER,
    MOVE_LAST_RESPECTS,
    MOVE_ACROBATICS, //63
    MOVE_TELEPORT,
    MOVE_MILK_DRINK,
